...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\linewidth]{img/s2/elec/CircuitMoteurDC}
...
\cite{nte_electronics_inc_nte3131_2008}\todo{add citation}
...
Ce circuit est illustré sur la figure ci-dessous \todo{add ref to fig} \cite{sharp_application_1999}.
...
\todo[inline]{add figures: Circuit de sortie de l'Arduino}

Sur la figure 4\todo{add ref to figure} ci-dessus, il y a une résistance de 390~$\omega$ en série avec chacune des DEL, car la tension aux bornes de ce type de DEL varie typiquement autour de 3,2~V \cite{noauthor_data_2007}.
