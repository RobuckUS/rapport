...
Par ailleurs, le moteur doit recevoir une tension d’alimentation de 7,4~V comme indiqué sur la figure~\ref{fig:s2-elec-RegulateurTension}.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\linewidth]{img/s2/code/pseudo-robot}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\linewidth]{img/s2/code/pseudo-verres}
